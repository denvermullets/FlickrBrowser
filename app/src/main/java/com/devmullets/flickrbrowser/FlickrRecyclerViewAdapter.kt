...
class FlickrImageViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    var thumbnail: ImageView = view.findViewById(R.id.browse_photo_image)
    var title: TextView = view.findViewById(R.id.browse_photo_title)
    var photoAuthor: TextView = view.findViewById(R.id.browse_photo_author)
...
//        Log.d(TAG, ".onBindViewHolder: ${photoItem.title} --> $position")
            ...
            holder.photoAuthor.text = photoItem.author
        }
    }
